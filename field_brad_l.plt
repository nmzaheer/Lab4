...
set key left top
set output 'field_L_brad.pdf'
plot 'brad3-2_L1.dat' using 9 title '50% Field' w l ls 1, \
'brad3-2_L2.dat' using 9 title '100% Field' w l linestyle 2, \
'brad3-2_L3.dat' using 9 title '150% Field' w l ls 3