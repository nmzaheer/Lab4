...
set key left top
set output 'load_L_brad.pdf'
plot 'brad3-1_L1.dat' using 9 title '50% Load' w l ls 1, \
'brad3-1_L2.dat' using 9 title '100% Load' w l linestyle 2, \
'brad3-1_L3.dat' using 9 title '150% Load' w l ls 3
